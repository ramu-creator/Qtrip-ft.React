...
function Niaboytown(){
    ...
    useEffect(()=>{
        fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures/detail?adventure=2447910730")
        .then(res=>res.json())
        .then(data=>{
            setState([data]);
            console.log(data);   
