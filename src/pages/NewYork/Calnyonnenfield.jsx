...
function Calnyonnenfield(){
    ...
    useEffect(()=>{
        fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures/detail?adventure=6302945339")
        .then(res=>res.json())
        .then(data=>{
            setState([data]);
            console.log(data);   
...
export default Calnyonnenfield;