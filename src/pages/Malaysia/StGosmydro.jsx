...
function StGosmydro(){
    ...
    useEffect(()=>{
        fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures/detail?adventure=0306928663")
        .then(res=>res.json())
        .then(data=>{
            setState([data]);
            console.log(data);   
