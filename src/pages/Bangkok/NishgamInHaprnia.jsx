...
function NishgamlnHaprnia(){
    const [state,setState] = useState([]);
    useEffect(()=>{
        fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures/detail?adventure=8304353098")
        .then(res=>res.json())
        .then(data=>{
            setState([data]);
            console.log(data);   
        ...
        <div id="niaboy">
            {state.map(item=>{
                return(
                     <>
                        <div id="carousel">
                            <h1 id="ni-i">NishgamlnHaprnia</h1>
...
export default NishgamlnHaprnia;